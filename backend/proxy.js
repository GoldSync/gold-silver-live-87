...
async function sendErrorAlert(subject, message, type = 'general') {
    ...
    try {
        ...
        const mailOptions = {
            from: `"SPM System Monitor" <${process.env.GMAIL_USER}>`,
            to: adminEmail,
            ...
            html: `
                <div style="font-family: sans-serif; padding: 20px; border: 2px solid #ff4444; border-radius: 10px;">
                    ...
                    <hr />
                    <p style="font-size: 0.8em; color: #666;">Generated by SPM Proxy at ${new Date().toLocaleString()}</p>
                </div>
            `
        };
...
app.post('/api/onboarding/complete', async (req, res) => {
    try {
        ...
        try {
            ...
            const mailOptions = {
                from: `"Swiss Precious Metals" <${process.env.GMAIL_USER}>`,
                to: adminEmail,
                subject: 'Welcome to SPM Live - Setup Complete',
                html: `
                    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
                        <h2 style="color: #ab8c56;">Welcome, ${adminName}!</h2>
                        <p>Your SPM Live Visual Manager setup is complete. You can now manage your live dashboard and assets.</p>
                        ...
                        <p style="font-size: 0.8em; color: #666;">This is an automated notification from your local SPM Proxy server.</p>
                    </div>
                `
            };
